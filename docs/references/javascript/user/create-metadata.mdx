...
<Properties>
  ...
  The value of the phone number, in [E.164](https://en.wikipedia.org/wiki/E.164) format.
</Properties>
...
<Properties>
  ...
  In [Ethereum](https://docs.metamask.io/wallet/reference/eth_getencryptionpublickey/#eth_getEncryptionPublicKey), the address is made up of `0x + 40` hexadecimal characters.
</Properties>
