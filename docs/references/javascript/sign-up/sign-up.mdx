...
<Properties>
  ...
  The Web3 wallet public address supplied to the current sign-up. In [Ethereum](https://docs.metamask.io/guide/common-terms.html#address-public-key), the address is made up of `0x` + `40 hexadecimal characters`.
...
<Properties>
  ...
  The user's Web3 wallet public address. In [Ethereum](https://docs.metamask.io/guide/common-terms.html#address-public-key), the address is made up of `0x` + `40 hexadecimal characters`.
...
- [`authenticateWithCoinbase()`](/docs/references/javascript/sign-up/authenticate-with#authenticate-with-coinbase)
