...
<Properties>
  - `strategy`
  - `'phone_code' | 'email_code' | 'email_link' | 'saml' | 'oauth_<provider>' | 'web3_metamask_signature' | 'web3_coinbase_signature'`
...
<Properties>
  - `strategy`
  - `'phone_code' | 'email_code' | 'web3_metamask_signature' | 'web3_coinbase_signature'`
